...
List<String?> genResToList( List<dynamic> genredIds)=>
    genredIds.map( (id) => _genreMap[id]).toList();

String getGenreValues( List<dynamic> genredIds){
  StringBuffer buffer = new  StringBuffer();
  buffer.writeAll(  genResToList(genredIds),", ");
